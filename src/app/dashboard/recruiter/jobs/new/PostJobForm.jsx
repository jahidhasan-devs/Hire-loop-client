        ...
        <div className="mb-5 rounded-md border border-zinc-800 bg-[#191919] px-4 py-3">
          ...
          {company.status !== "approved" && (
            <p className="mt-2 border-t border-zinc-800 pt-2 text-[9px] text-zinc-500">
              Your company is currently waiting for approval. You can post jobs
              after your company is approved.
            </p>
          )}
        </div>
                    ...
                    <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                      ...
                      <div className="text-left sm:text-right">
                        ...
                        <p className="mt-1 text-[10px] text-zinc-300">
                          {company.activeJobs} active / {company.jobLimit}{" "}
                          allowed
                        </p>
                      </div>
                    </div>
